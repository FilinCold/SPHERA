---
name: gemini-api-coding-guidelines
description: Use when writing JavaScript or TypeScript code that interacts with the Gemini API to ensure use of the official @google/genai library.
---
