...
//нужно сделать так чтобы компоненты добавлялись через map и как массив были карточки
//сосредоточится на интерфейсе
//посмотреть store чтобы не крутить логику в пропсах
//сделать адаптив для всех файлов стилей
