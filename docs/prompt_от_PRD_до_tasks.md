  ...
  "tasks": [
    {
      ...
      "acceptance_criteria": ["Конкретный критерий приёмки 1", "Конкретный критерий приёмки 2"],
      "test_steps": ["Шаг 1: что сделать", "Шаг 2: что проверить", "Шаг 3: ожидаемый результат"],
